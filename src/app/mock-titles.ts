...
export const TITLES: Title[] = [
  new Title("Under the Sign of the Black Mark", "Bathory", "Third album from the godfather of modern black metal, the bridge between the two styles that Bathory is most famous for.", "vinyl, CD, cassette", "$10-$16", 3),
